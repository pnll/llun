...
<table width="968" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
        ...
        <td width="910" height="60">
                ...
                <tr>
                    <td width="290" rowspan="4"><a href="http://pinull.tistory.com/"><img src="http://llun.com/v2/images/title.gif" width="290" height="90" border="0" alt="Off The Record : 비보도"></a></td>
                    <td width="85" rowspan="3" valign="top"><img src="http://llun.com/v2/images/b1.gif" width="78" height="29" border="0"></td>
                        <td width="70"><a href="http://pinull.tistory.com/category/Today%20Photo" class="me">&nbsp;<img src="http://llun.com/v2/images/b1_icon.gif" width="10" height="5" border="0">Gallery</a></td>
                    ...
                    <td width="85" valign="top" rowspan="3"><img src="http://llun.com/v2/images/b3.gif" width="78" height="29" border="0"></td>
                        <td width="70"><a href="http://pinull.tistory.com/category/사진관련" class="me">&nbsp;<img src="http://llun.com/v2/images/b3_icon.gif" width="10" height="5" border="0">Lecture</a></td>
                    <td width="85" valign="top" rowspan="3"><img src="http://llun.com/v2/images/b4.gif" width="78" height="29" border="0"></td>
                        <td width="70"><a href="http://pinull.tistory.com/685" class="me">&nbsp;<img src="http://llun.com/v2/images/b4_icon.gif" width="10" height="5" border="0">Profile</a></td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="70"><a href="http://pinull.tistory.com/category/Archive" class="me">&nbsp;<img src="http://llun.com/v2/images/b1_icon.gif" width="10" height="5" border="0">Archive</a></td>
                        <td width="70">&nbsp;</td>
                        <td width="70">&nbsp;</td>
                        <td width="70">&nbsp;</td>
                    </tr>
